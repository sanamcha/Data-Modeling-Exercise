DROP DATABASE IF EXISTS air_traffic1;

CREATE DATABASE air_traffic1;

\c air_traffic

CREATE TABLE domestic_US_flights
(
...
INSERT INTO domestic_US_flights
  (first_name, last_name, seat, departure, arrival, airline, from_city,to_city)
VALUES
('Jennifer', 'Finch', '33B', '2018-04-08 09:00:00', '2018-04-08 12:00:00', 'United', 'Washington DC', 'States', 'Seattle'),
